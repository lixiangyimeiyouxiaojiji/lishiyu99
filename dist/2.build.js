...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    methods: {
	        //            获取屏幕可见区域宽高
	        screenWatch: function screenWatch() {
	            this.mainStyle.height = parseInt(document.body.clientHeight) - 72 + 'px'; //网页可见区域高
	            this.mainStyle.width = document.body.clientWidth + 'px'; //网页可见区域宽
	        }
	    }
	};
