...
<template>
  ...
  <div id="preloader">
      <div id="status">
        <img alt="logo" src="../../../../assets/image/logo-big.png">
      </div>
    </div>
    <!--/.PRELOADER END-->
    ...
    <div class="header">
      <div class="for-sticky">
        ...
        <div class="col-md-2 col-xs-6 logo">
          <a href="index.html"><img alt="logo" class="logo-nav" src="../../../../assets/image/logo.png"></a>
        </div>
        <!--/.LOGO END-->
      </div>
      <div class="menu-wrap">
      ...
      <div class="content">
                ...
                <div class="col-md-12">
                  <div class="wrap-about">
                    <div class="w-content">
                      ...
                      <img alt="signature" src="../../../../assets/image/signature.png">
                    </div>
                  </div>
                </div>
                ...
                <div class="grid">
                  <div class="grid-item">
                    <div class="wrap-article">
                      <img alt="blog-1" class="img-circle text-center" src="../../../../assets/image/blog-1.png">
                  ...
                  <div class="grid-item">
                    <div class="wrap-article">
                     <img alt="blog-4" class="img-circle text-center" src="../../../../assets/image/blog-4.jpg">
                     <p class="subtitle fancy">
                  ...
                  <div class="grid-item">
                    <div class="wrap-article">
                      <img alt="blog6" class="img-circle text-center" src="../../../../assets/image/blog-6.jpg">
                      <p class="subtitle fancy">
                  ...
                  <div class="grid-item">
                    <div class="wrap-article">
                      <img alt="blog2" class="img-circle text-center" src="../../../../assets/image/blog-2.jpg">
                      <p class="subtitle fancy">
                  ...
                  <div class="grid-item">
                    <div class="wrap-article">
                      <img alt="blog5" class="img-circle text-center" src="../../../../assets/image/blog-5.jpg">
                      <p class="subtitle fancy">
                  ...
                  <div class="grid-item">
                    <div class="wrap-article">
                      <img alt="blog-3" class="img-circle text-center" src="../../../../assets/image/blog-3.jpg">
                      <p class="subtitle fancy">
                        <span>08/03/2015</span>
                      </p>
                      <a href="#">
        ...
        <footer>
          ...
          <div class="footer-bottom">
            <div class="container">
              <div class="row">
                <img src="../../../../assets/image/logo-bottom.png" alt="logo bottom" class="center-block" />More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a>
              </div>
            </div>
          </div>
        </footer>
...
<script>
    import m from '../../../../assets/js/main.js'
    import t from '../../../../assets/js/typed.js'
    export default{
        data(){
            return {
